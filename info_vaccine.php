...
if (isset($_SESSION['customer_id'])) {
    ...
    $vac_query = "SELECT * FROM vaccination_details";
    ...
    <div class="container mt-5">
        <div class="panel panel-default ">
            <div class="panel-heading">
                <h2 class="panel-title">Vaccination Schedule</h2>
                <div class="input-group mb-3">
                    <input type="text" id="searchInput" class="form-control" onkeyup="searchTable()" placeholder="Search by Vaccine or age...">
                    <div class="input-group-append">
                        <button class="btn btn-primary" type="button"><i class="fas fa-search"></i></button>
                    </div>
                </div>
            </div>
            <div class="panel-body blar">
                <table class="table table-striped">
                    <thead class="btn-primary">
                        <tr>
                            <th><h5>Vaccine Name</h5></th>
                            <th><h5>Before age</h5></th>
                            
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($vac_result)) : ?>
                            <tr>
                                <td><h6><?php echo $row['vaccination_name']; ?></h6></td>
                                <td><h6><?php echo $row['before_age']; ?></h6></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
